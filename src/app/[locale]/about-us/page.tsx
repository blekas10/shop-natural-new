...
export default async function AboutPage({
  ...
  const milestones = [
    ...
    },
    {
      year: "2020",
      title:
        locale === "en" ? "Organic Certification" : "Ekologinis sertifikatas",
      description:
        locale === "en"
    ...
    },
    {
      year: "2022",
      title:
        locale === "en" ? "International Expansion" : "Tarptautinis plėtimasis",
      description:
        locale === "en"
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gradient-to-br from-natural-green-50 to-natural-green-100 p-8 rounded-2xl shadow-lg">
                  <div className="text-4xl font-bold text-natural-green-500 mb-2">
                    100%
                  </div>
                  ...
                  >
                    ...
                    <div className="ml-16 md:ml-20">
                      <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-natural-green-100">
                        <div className="text-lg font-bold text-natural-green-500 mb-2">
                          {milestone.year}
                        </div>
                        <h3 className="text-xl font-semibold text-natural-green-600 mb-2">
                          {milestone.title}
                        </h3>
                        <p className="text-natural-gray-400 leading-relaxed">
              ...
              {teamMembers.map((member) => (
                ...
                >
                  ...
                  <div className="p-6 text-center">
                    ...
                    <p className="text-natural-green-500 font-medium mb-3">
                      {member.role}
                    </p>
                    <p className="text-natural-gray-400 leading-relaxed">
                      {member.bio}
